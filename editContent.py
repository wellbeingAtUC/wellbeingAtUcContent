...
def main():
    ...
    for file in files:
        ...
        try:
            ...
            inputVideo = VIDEOS_FOLDER + "/testVideo.mp4"
            ...
            driveClient.upload_file(finalWithSubs, DEST_DIR, "video/mp4")
            ...
            for f in [local_file, localMusic, output_file, final, finalWithSubs, subsFile]:
